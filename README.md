...
- Chrome：`video-batch-assistant-chrome-v1.2.3.zip`
- Edge：`video-batch-assistant-edge-v1.2.3.zip`
...
“发表后等待”默认是 10 秒，可以填写 0 关闭间隔。倒计时只发生在两条视频之间，最后一条完成后立即结束批次；等待期间仍可点击“停止”。

...
- 提供可选的“发表前人工检查全部内容”；继续后不审查人工修改，直接点击发表。
...
该功能默认关闭。启用后，每个视频在即将发表时暂停：

1. 可人工修改描述、短标题、链接、标注、原创声明或封面；
2. 修改完成后点击助手的“继续”；
3. 扩展不比较、不恢复也不审核人工修改，只取得当前可点击的“发表”按钮并点击。

如果人工修改导致网站“发表”按钮不可用，扩展无法强制发表，并会给出暂停信息。

如果同时勾选“人工编辑封面”和“人工检查全部内容”，助手只在“全部内容”阶段暂停一次；此时可一并完成封面编辑。
...
Edge 的每类等待时限比 Chrome 增加 10 秒。人工选择剧集、人工完成原创声明、人工编辑封面和发表前人工检查均不设超时。
...
- “发表前人工检查全部内容”继续后不会审查人工改动，请在点击“继续”前自行核对。
